 ...
 * @param  n            The number of trappazoids
 * @param  my_rank      The rank of the process so you know what process it is
 * @param  p            The total number of processes running
 * @return long double  The calulated value from the equation
 */

long double integrate(long double a, long double b, long double n,
                      int my_rank, int p) {
  // Decalare Variables
